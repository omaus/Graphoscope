...
type GraphoscopeBenchmark() =
    ...
    //[<GlobalSetup>]
    //member _.SetupSmallGraph() =
    //    FGraphs.n20e27

    //[<GlobalSetup>]
    //member _.SetupMiddleGraph() =
    //    FGraphs.n200e270

    //[<GlobalSetup>]
    //member _.SetupBigGraph() =
    //    FGraphs.n2000e2700
    ...
    [<Benchmark>]
    member _.fgn20e27BFS1000Times() =
        let nk1 = FGraph.getNodes FGraphs.n20e27 |> Seq.head |> fst
        for i = 1 to 1000 do
            BFS.ofFGraph nk1 FGraphs.n20e27 |> ignore

    [<Benchmark>]
    member _.fgn200e270BFS1000Times() =
        let nk1 = FGraph.getNodes FGraphs.n200e270 |> Seq.head |> fst
        for i = 1 to 1000 do
            BFS.ofFGraph nk1 FGraphs.n200e270 |> ignore

    //[<Benchmark>]
    //member _.fgn2000e2700BFS1000Times() =
    //    let nk1 = FGraph.getNodes FGraphs.n2000e2700 |> Seq.head |> fst
    //    for i = 1 to 1000 do
